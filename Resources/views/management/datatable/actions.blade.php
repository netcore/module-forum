<div class="btn-group">
    <button type="button" class="btn btn-xs btn-info btn-outline btn-outline-colorless dropdown-toggle"
...
<a href="javascript:" class="btn btn-xs btn-{{ $thread->trashed() ? 'success' : 'danger' }} toggle-thread"
   data-attribute="deleted_at" data-thread-id="{{ $thread->id }}">
